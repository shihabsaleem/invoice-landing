...
export default function InvoicePreview({ data, invoiceRef, removeBranding, pdfMode }: Props) {
            ...
            <table className="w-full mb-6" style={{ pageBreakInside: 'avoid' }}>
                <thead className="bg-slate-50 text-slate-600 font-semibold text-[9px]">
                    <tr>
                        ...
                        {config.enableDiscount && <th className="text-right py-2 px-2 w-[10%]">Disc</th>}
